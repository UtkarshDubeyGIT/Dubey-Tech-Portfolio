...
- **PR-AUC**: 0.5477 (Traditional) → **0.5498** (Fuzzy-Monotonic) ↑
- **Brier Score**: 0.1725 (Traditional) → **0.1696** (Fuzzy-Monotonic) ↓
- **ROC-AUC**: 0.7744 (Traditional) → 0.7700 (Fuzzy-Monotonic)
...
SHAP values showed _which_ features mattered. Fuzzy rules showed _why_ they mattered in human terms. Together, they created a two-tier explanation:
...
_Built with ❤️ for transparent and responsible AI in financial services_
